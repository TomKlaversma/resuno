        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#diensten" className="text-gray-400 hover:text-white transition-colors">
                  Diensten
                </a>
              </li>
              <li>
                <a href="#over" className="text-gray-400 hover:text-white transition-colors">
                  Over Resuno
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <a href="mailto:tom@resuno.nl" className="hover:text-white transition-colors">
                  tom@resuno.nl
                </a>
              </li>
              <li>Nederland</li>
